...
import { Shield, CheckCircle2, Users, Scale, BookOpen, Building2, ArrowRight, ExternalLink } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section id="contact" className="max-w-7xl mx-auto px-6 pb-20">
        <motion.div {...fadeUp()} className="bg-gradient-to-r from-rose-600 to-fuchsia-700 text-white p-8 rounded-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
          ...
          <a href="mailto:hello@themosaic.pro?subject=POSH%20Compliance%20Proposal" className="bg-white text-rose-700 px-6 py-3 rounded-xl font-semibold hover:bg-rose-50 transition">Email us</a>
        </motion.div>
      </section>
    </div>
  );
